...
# prediccion_preparacion_pandemias documentation build
...
from prediccion_preparacion_pandemias import __version__ as release

# -- Project information -----------------------------------------------------

project = "prediccion_preparacion_pandemias"
author = "Kedro"
...
htmlhelp_basename = "prediccion_preparacion_pandemiasdoc"
...
latex_documents = [
    (
        master_doc,
        "prediccion_preparacion_pandemias.tex",
        "prediccion_preparacion_pandemias Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "prediccion_preparacion_pandemias",
        "Project prediccion_preparacion_pandemias codebase.",
        "Data-Science",
    )
]
