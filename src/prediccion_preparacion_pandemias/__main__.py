"""Prediccion Preparacion Pandemias file for ensuring the package is executable
as `prediccion-preparacion-pandemias` and `python -m prediccion_preparacion_pandemias`
"""
import importlib
